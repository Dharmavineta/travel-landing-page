    ...
    <section className=" 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite
          ...
          title="Hampi Camp"
          subtitle="Ancient, Alive"
          peopleJoined="50+ Joined"
        />
        <CampSite
          backgroundImage="bg-bg-img-2"
          title="River View Camp"
          subtitle="Hampi, Malyavanta"
          peopleJoined="50+ Joined"
        />
      </div>
      <div className="flexEnd mt-10 px-6  lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[700px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            ...
            quia, ducimus autem libero amet qui quasi enim at architecto,
            asperiores aut. Velit, optio repellendus!
          </p>
          <Image
            src={"/quote.svg"}
            alt="camp-2"
